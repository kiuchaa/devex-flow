		...
		<div class="row align-items-center g-5">
			...
			<div class="col-lg-6 <?php echo esc_attr( $content_order ); ?>">
				<div class="b-text-image__content">
					<?php if ( $title ) : ?>
						<h2 class="display-5 fw-bolder mb-4 ls-tight" data-aos="fade-up" data-aos-duration="1500">
							<?php echo esc_html( $title ); ?>
						</h2>
					<?php endif; ?>

					<?php if ( $text ) : ?>
						<div class="lead text-secondary mb-5" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="250">
							<?php echo wp_kses_post( $text ); ?>
						</div>
					<?php endif; ?>

					<?php if ( $button ) : ?>
						<div class="b-text-image__button" data-aos="fade-in" data-aos-duration="750" data-aos-delay="350">
							<?php
